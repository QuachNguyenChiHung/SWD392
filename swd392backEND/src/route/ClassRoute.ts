...
route.post("/teacher/upload-image", verifyRole.verifyTeacher, imageMulterUpload.single("image"), ClassController.uploadImageCover);
route.put("/teacher/update-image", verifyRole.verifyTeacher, imageMulterUpload.single("image"), ClassController.updateImageCover);
