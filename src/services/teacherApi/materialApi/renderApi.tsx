...
class RenderApiService {
  ...
  async updateRender(
    renderId: string,
    updateData: UpdateRender2DDTO,
  ): Promise<Render2DMaterial> {
    const data = await apiService.put(`/renders/${renderId}`, updateData);
    return data;
  }
  ...
  async saveRenderData(renderData: any): Promise<Render2DMaterial> {
    const data = await apiService.post("/renders", {
  ...
  async updateRenderData(
    ...
    const data = await apiService.put(`/renders/${renderId}`, {
      render_data: renderData,
    });
    return data;
  }
