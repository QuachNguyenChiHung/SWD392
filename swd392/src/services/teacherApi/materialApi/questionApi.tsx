...
class QuestionApiService {
    ...
    private convertToFrontendFormat(backendData: any): Question {
        ...
        const correctAnswer =
            backendData.correct_index != null && backendData.correct_index < options.length
    ...
    private convertToBackendUpdateFormat(frontendData: FrontendQuestionData): UpdateQuestionDTO {
        const backendType: 'multiple_choice' | 'true_false' =
            frontendData.type === 'true-false' ? 'true_false' : 'multiple_choice';
    ...
    async updateQuestionFromFrontend(questionId: string, frontendData: FrontendQuestionData): Promise<Question> {
        const backendData = this.convertToBackendUpdateFormat(frontendData);
        const response = await apiService.put(`/questions/${questionId}`, backendData);
        const data = response.data || response;
        return this.convertToFrontendFormat(data);
    }
